...
SECRET_KEY = 'django-insecure-lcdruozv-@%k_zv1=$5+lbkw7r^1weq#z)r-4-a4vk8x1yqu%n'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', #added essential cors middleware 1/2
    'django.middleware.common.CommonMiddleware', #added essential cors middleware 2/2   
