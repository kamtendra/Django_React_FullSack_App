...
#custom permission class (view level permission edit)
...
The following generic views are provided by the generic views API:

    GenericAPIView: The base class for all other generic views.
